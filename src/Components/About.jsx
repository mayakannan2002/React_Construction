...
const About = () => {
  ...
  return (
    <div className="about-container">
      <div id="about-section" className="heading">
      ...
      <div className="about-content">
        ...
        <div id="key-info" className="key-info">
            ...
            <div key={index} className="accordion-item">
              ...
              {activeIndex === index && (
                <div className="accordion-content">
                  <p id={`accordion-content-${index}`}>{item.content}</p>
                </div>
              )}
            </div>
          ))}
        ...
        <div id="additional-content" className="additional-content">
          <div id="content-left" className="content-left">
            <h4>Our Values</h4>
            <p>
          ...
          <div id="content-right" className="content-right">
            <h4>Why Choose Us?</h4>
            <p>
        ...
        <div id="bangalore-builders">
          <p>Builders in Bangalore: A Hub of Innovation and Quality
          Bangalore, often referred to as the Silicon Valley of India, is not only a technology hub but also a booming center for the construction industry. Builders in Bangalore cater to diverse needs, from luxurious residential apartments to state-of-the-art commercial spaces. The city boasts some of the best infrastructure, with projects emphasizing modern architecture, sustainability, and timely delivery. Top builders incorporate advanced technologies and eco-friendly designs, ensuring structures align with global standards. As demand for housing and office spaces continues to grow, builders in Bangalore focus on creating smart homes, green buildings, and premium amenities, making the city a preferred destination for investors and homebuyers alike.</p>
        </div>
      </div>
    </div>
  );
